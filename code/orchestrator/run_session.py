...
SALEAE_DIGITAL_CHANNELS = [0, 1, 2, 3, 4]  # D0=INT1 (Pin 15), D1=decision GPIO (Pin 11), D2=PCA9685 PWM; ch3=SDA, ch4=SCL added 2026-09-24 for on-wire protocol evidence capture
...
def run_class_capture(class_name, duration_sec, session_dir, jetson_session_dir, odr_hz):
    ...
    with automation.Manager.connect(port=SALEAE_PORT) as manager:
        device_config = automation.LogicDeviceConfiguration(
            ...
            digital_threshold_volts=3.3,  # corrected 2026-09-24: 1.8V threshold caused phantom edges on 3.3V open-drain I2C
            glitch_filters=[
