...
% IEEE_lsens.cls defines \thetable as Arabic (symmetric with \thefigure,
% no documented rationale) -- standard IEEE house style numbers tables
% with Roman numerals ("TABLE I") while figures stay Arabic ("Fig. 1").
% Overridden here rather than in the class file to keep the upstream
...
\bibitem{ref4} A.~Swami, ``Pre-registration chain for the sensor-mlc-latency study (v6.1--v7.13),'' Zenodo, 2026, doi:10.5281/zenodo.22907600.
