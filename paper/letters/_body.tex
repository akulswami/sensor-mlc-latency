...
\textbf{Fig. 1} reveals multimodal structure in both MLC pipelines: the mlc/idle distribution is bimodal (mean 866.6 $\mu$s exceeds median 681.5 $\mu$s, p95 1,780.7 $\mu$s), and mlc-binary/idle shows three modes near 60, 240, and 470 $\mu$s. Both collapse to tighter distributions under contention and stress. We report this as exploratory.
