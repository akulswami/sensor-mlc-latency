...
No cell exceeded the pre-registered 10% exclusion ceiling (highest: mlc/idle, 2.78%). Of 90 excluded trials (1.85% of candidates), the dominant category was multiple_d1_in_window (68/90, 75.6%), attributable to the 706.5 ms cadence interacting with stimulus-window boundaries; the remainder split evenly between no_d1_in_window and multiple_d0_before_d1 (11 each).
