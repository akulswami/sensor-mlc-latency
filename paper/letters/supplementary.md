...
Table I in the main text reports only median and IQR per pipeline×condition cell, to fit the page budget. The full table, including p95 and mean, is reproduced here.
