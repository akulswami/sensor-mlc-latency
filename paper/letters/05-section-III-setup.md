...
The sensor is an STMicroelectronics LSM6DSOX 6-axis IMU on an Adafruit breakout (PID 4438; onboard 3.3 V regulation and 10K I²C pull-ups) on I²C bus 7 (pins 3/5, address 0x6A) at 400 kHz (Fast Mode, Jetson default). All three pipelines configure the accelerometer identically (CTRL1_XL = 0x50: 208 Hz, ±2 g, LPF2 off). The MLC runs at 104 Hz (EMB_FUNC_ODR_CFG_C = 0x35: MLC_ODR = 0b11, half the 208 Hz accelerometer ODR) with a custom 2-class motion/still classifier (75-sample windows, config mlc_motion_w75.h) trained in ST MEMS Studio, with output routed to INT1.
