...
**Response:** We conducted a targeted, pre-registered follow-up investigation (amendment v7.12, DOI 10.5281/zenodo.22907481; correction v7.13, DOI 10.5281/zenodo.22907600) testing the two most plausible candidate mechanisms: process-affinity placement and IRQ-routing variability. Both were systematically excluded:
